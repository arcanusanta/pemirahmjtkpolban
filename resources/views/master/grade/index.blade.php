...
@section('section-head')
    <ol class="breadcrumb bg-primary text-white-all">
        ...
        <li class="breadcrumb-item"><a href="{{ route('grade.index') }}">{{ __('Data') }}</a></li>
    </ol>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="col">
                        @can('Grade Create')
                            <a href="{{ route('grade.create') }}" class="btn btn-primary float-right"><span class="fas fa-plus"></span> {{ __('Tambah') }}</a>
                        @endcan
                    </div>
                </div>
